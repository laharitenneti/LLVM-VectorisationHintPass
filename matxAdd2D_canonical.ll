...
for.inc14:                                        ; preds = %for.end
  ...
  br i1 %cmp, label %for.body, label %for.end16, !llvm.loop !8
...
for.inc11:                                        ; preds = %for.end
  ...
  br i1 %cmp, label %for.body, label %for.end13, !llvm.loop !10
...
for.body17:                                       ; preds = %for.end13, %for.inc18
...
for.inc18:                                        ; preds = %for.body17
  ...
  br i1 %cmp16, label %for.body17, label %for.end20, !llvm.loop !11
...
for.end20:                                        ; preds = %for.inc18
  ...
  %0 = load float, ptr getelementptr inbounds ([1000 x float], ptr getelementptr inbounds ([1000 x [1000 x float]], ptr @_ZZ4mainE1C, i64 0, i64 500), i64 0, i64 500), align 4
  %call32 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSt3__113basic_ostreamIcNS_11char_traitsIcEEElsEf(ptr noundef nonnull align 8 dereferenceable(8) @_ZNSt3__14coutE, float noundef %0)
